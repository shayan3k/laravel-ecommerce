...
<head>
	...
	<!-- Register Styles -->
    <link href="https://fonts.googleapis.com/css?family=Montserrat&display=swap" rel="stylesheet">	<link rel="stylesheet" href="css/animate.css">
		...
		<div class="shop-blog">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<article class="article-entry">
                            <a href="blog.html" class="blog-img" style="background-image: url(images/blog-2.jpg);">                                <p class="meta"><span class="day">02</span><span class="month">Mar</span></p>
                                <div class="mask d-flex justify-content-center align-items-center">
                                    <button class='btn-blog'>Read</button>
                                </div>
					...
					<div class="col-md-4">
						<article class="article-entry">
                            <a href="blog.html" class="blog-img" style="background-image: url(images/blog-3.jpg);">                                <p class="meta"><span class="day">02</span><span class="month">Mar</span></p>
                                <div class="mask d-flex justify-content-center align-items-center">
                                    <button class='btn-blog'>Read</button>
                                </div>                            </a>
							<div class="desc">
